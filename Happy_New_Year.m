...
figure('Color',rand(1,3), 'Position', [500 200 500 500])
x=[1:0.01:40];
plot3(sin(x).*exp(-x/20), cos(x).*exp(-x/20),x, 'gx')
set(gca,'Color',[0.22 0.44 0.33])
axis([-1 1 -1 1 0 40]);
grid on;
text(-0.55,0.8,41,'Feliz Navidad y Próspero 2022', 'Color','b', 'FontSize', 14)
text(-0.8,-1,0,'HO-HO-HO', 'Color','w', 'FontSize', 14, 'FontWeight','bold','Rotation',90)
letitsnow
